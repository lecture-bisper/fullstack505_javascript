...
// 배열, object 의 요소를 변수에 대입 시 대입 연산자 왼쪽에 변수명을 나열하고, 오른쪽에는 배열 및 object 변수를 위치시켜서 배열 및 object 변수의 요소를 차례대로 대입시키는 방식
...
// ES6 에서는 구조 분해 할당을 사용하여 임시 변수없이 데이터의 스왑이 가능함
...
// obj의 key 이름과 동일한 이름의 변수에 ': 새변수명' 을 사용 시 동일한 이름의 key 값이 새변수에 대입 됨
var {key1: newKey1, key2, key3 = 'default key3 value'} = obj;
console.log(`key1 : ${key1}, key2 : ${key2}, key3 : ${key3}, newKey1 : ${newKey1}`);



// 확장 표현식 : ES6에서 제공되는 표현식으로 object 타입의 key에 값을 변수의 값을 대입할 경우 key 이름과 변수의 이름이 같으면 key 이름을 생략 가능
...
// combined['oneother'] = 'some value';를 한 것과 동일함
...
// key이름을 생략 시 변수 이름이 key이름으로 사용됨
var obj = {x, y};
console.log(obj);
