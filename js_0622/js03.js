...
// let : ES6에서 추가된 변수를 선언하는 키워드, 변수가 메모리상에 존재하는 기준이 코드 블럭임, 동일한 이름의 변수를 중복 선언할 수 없음, 변수에 저장된 값을 변경할 수 있음
// const : ES6에서 추가된 상수를 선언하는 키워드, 상수가 메모리상에 존재하는 기준이 코드 블럭임, 동일한 이름의 변수를 중복 선언할 수 없음, 상수에 저장된 값(리터럴) 변경할 수 없음
...
// const 키워드로 변수 arr2를 상수로써 빈 배열로 선언
const arr2 = [];
console.log(arr2);
...
// 기존 생성된 object 타입의 변수에 key와 값을 추가
obj2['name'] = '아이유';
console.log(obj2);
...
// 전개 연산자를 사용하여 새 배열을 생성하고 새배열의 요소로 arr14의 모든 요소와 추가되는 데이터를 새 배열 arr15에 저장
