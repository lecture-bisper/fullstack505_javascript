...
// 전개 연산자를 사용하여 배열 array1의 모든 요소와 배열 array2의 모든 요소를 합하여 combined 에 대입, 하나의 배열로 생성함
...
// others 는 배열로 동작함, 오른쪽에 있는 배열 array1의 요소가 others까지 데이터를 대입하기 못하기 때문에 빈배열로 출력됨
...
// delete 명령으로 others의 요소 중 other를 삭제
delete others.other;
console.log(others);
